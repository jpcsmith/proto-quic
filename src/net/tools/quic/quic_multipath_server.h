...
#ifndef NET_TOOLS_QUIC_QUIC_MULTIPATH_SERVER_H_
#define NET_TOOLS_QUIC_QUIC_MULTIPATH_SERVER_H_
...
class QuicMultipathServer : public EpollCallbackInterface {
 public:
  QuicMultipathServer(std::unique_ptr<ProofSource> proof_source,
...
#endif  // NET_TOOLS_QUIC_QUIC_MULTIPATH_SERVER_H_
